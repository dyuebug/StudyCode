...
> Code Example：[assert.c](2%20-%20Source%20Material/C++Study/C++/CppNote/CPlusPlusThings-master/english/basic_content/assert/assert.c)
```c
#include <stdio.h> 
#include <assert.h> 
...
> Code Example：[ignore_assert.c](2%20-%20Source%20Material/C++Study/C++/CppNote/CPlusPlusThings-master/english/basic_content/assert/ignore_assert.c)
