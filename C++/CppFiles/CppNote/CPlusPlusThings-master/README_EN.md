...
- [Talking about STL design and EBO optimization](谈谈STL设计之EBO优化.md)
- [rb_tree](rb_tree.md)
...
- [heap、stack、RAII：How to manage resources for C ++ ?](./learn_class/modern_cpp_30/RAII)
  ...
  - [stack](2%20-%20Source%20Material/C++Study/C++/CppNote/CPlusPlusThings-master/learn_class/modern_cpp_30/RAII/stack.cpp)
...
- [What exactly does r value and move solve？](./learn_class/modern_cpp_30/reference)
  - [L value and R value](reference.cpp)
  - [Extend the declaration cycle](lifetime.cpp)
  - [Reference folding](collapses.cpp)
  - [Perfect forward](forward.cpp)
...
Modified the code, [Click here for the code](2%20-%20Source%20Material/C++Study/C++/CppNote/CPlusPlusThings-master/tool/output/output_container.h)
...
- [How to output like python in C/C++](像Python一样玩CC++.md)
...
- [Debug Tool: dbg-macro](C++的Debug工具dbg-macro.md)

### 8.Expansion

#### 8.1 Other Problems
- [How to convert string to in C ++？](string_int.md)
...
![](2%20-%20Source%20Material/C++Study/C++/CppNote/CPlusPlusThings-master/img/wechat.jpg)
