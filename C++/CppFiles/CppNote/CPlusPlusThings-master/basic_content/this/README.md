...
![thiscontrust](2%20-%20Source%20Material/C++Study/C++/CppNote/CPlusPlusThings-master/basic_content/this/img/thiscontrust.png)

![genthis](2%20-%20Source%20Material/C++Study/C++/CppNote/CPlusPlusThings-master/basic_content/this/img/genthis.png)

会发现编译器自动为我们加上`A* const`，而不是`A const *this`！

紧接着，上述还有个常函数，那么我们在对`get_age`添加断点，如下：

![constthis](2%20-%20Source%20Material/C++Study/C++/CppNote/CPlusPlusThings-master/basic_content/this/img/constthis.png)
